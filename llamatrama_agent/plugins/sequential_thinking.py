def tool_sequential_thinking(argstr):
    """
    Tool wrapper for sequential_thinking. Accepts a JSON string (single object or list) and returns the result as JSON. Useful for stepwise reasoning in PiControl or other automation tasks.
    """
    try:
...
def sequential_thinking(thought_steps):
    ...
    Returns a list of processed steps with solution hypotheses and verification. Useful for automation, troubleshooting, or planning tasks for Raspberry Pi or other systems.
    """
    results = []
